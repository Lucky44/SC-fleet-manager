        ...
        <div className="max-w-full mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {fleet.map(fs => {
                    ...
                    if (!shipData) {
                        return (
                            <div key={fs.id} className="relative bg-red-950/20 border-4 border-sc-blue/80 rounded-2xl overflow-hidden p-6 shadow-xl backdrop-blur-sm">
                    ...
                    return (
                        <div key={fs.id} className="relative bg-sc-gray border-4 border-sc-blue/80 rounded-2xl overflow-hidden p-6 shadow-xl">
